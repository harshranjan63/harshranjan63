...
```yaml
name: Harsh Ranjan
located_in: Burla,Odisha
current_job: Backend Developer
education:
  [
    "Self-Taught Developer and Designer",
    "Bachelor's in Electronics and TeleCommunication from VSSUT,Burla",
  ]
...
technical_background:
  [
    "SDE at TidalWave Technologies"
  ]
  
currently_learning: ["Docker, Kubernetes,Node JS and React JS"]
